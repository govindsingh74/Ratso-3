      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-indigo-200">
            The future of decentralized applications powered by Polarity
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Built on Polarity for lightning-fast transactions and maximum security
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                True decentralization with Polarity blockchain integration
              </p>
            </div>
          </div>
        </div>
